function b = resistance_preqc(LP)
...
if LP.fullStruct == 1 
   for i = 1:length(LP.stats)
       if LP.sweepAmps(i)> -100 && LP.sweepAmps(i) < 0
          ...
          highest_deflection_all_sweeps = [highest_deflection_all_sweeps, ...
              min(LP.V{1,i}(LP.stimOn(1,i):LP.stimOff(1,i)))];
       end
   end  
end
