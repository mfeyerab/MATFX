...
rowNames = {'Standard';'Cell-wise: initial R_a';'Cell-wise: initial R_a fract'; ...
    'Cell-wise: electrode drift';
    'Cell-wise: initial membrane potential'; ...
    'Cell-wise: no suprathreshold or R_in';...
    'Sweep-wise: manual test pulse review'; ...
    'Sweep-wise: bridge balance abs'; ...
    ...
    'Spike-wise: max threshold'; ...
    'tau: GoF'; 'tau: maximum Deflection';  'tau: window for evalualtion';
...
T= array2table([["Current Run", "Allen White Paper"];...
    ...
    [PS.noSupraSub , "not implemented"]; ...  
    [PS.manTPremoval,"implemented"];
    ...
    [PS.GF, "not specified"];[PS.maxDefl, "not implemented"];...
    [PS.WinHD, "not specified"];...
...
diary([PS.outDest,'\','CommandOutput', date,'.txt']) 