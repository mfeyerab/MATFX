...
for n = 1:length(cellList)    
  ...
  if ~isfile(fullfile(outputfolder,[char(cellID), '.nwb']))
    ...
    nwb.general_subject = types.core.Subject( ...
     ...
     AnaTab = util.table2nwb(T(idx,[1, 49, 44, 54]));  
    ...
    if string(stimName)== "Short Square" || string(stimName)== "Long Square" ...
       ...
       elseif contains(stimName, 'Noise')
        ...
        [nwb, SweepAmp, StimOn, StimOff]  = importSweeps(nwb, ...
                 SweepAmp, StimOn, StimOff, stimName,...
 ...
 %% Intracellular Recordings Table   
    ...
    ic_rec_table = types.core.IntracellularRecordingsTable( ...
     ...
     'electrodes', types.core.IntracellularElectrodesTable( ...
        ...
        'colnames', {'electrode'}, ...
        'id', types.hdmf_common.ElementIdentifiers('data', int64([0:sweepCount-2])), ...
     ...
     'stimuli', types.core.IntracellularStimuliTable( ...
        ...
        'current_amplitude',  types.hdmf_common.VectorData('data', [SweepAmp'], ...
